...
function pa_live_search() {
    ...
    $search_post_icon = 'file-text-o';
    $search_page_icon = 'file-text-o';
    $search_kb_icon = 'file-text-o';
    $search_faq_icon = 'file-text-o';
    $search_document_icon = 'file-text-o';
    $search_video_icon = 'file-text-o';
    $search_default_icon = 'file-text-o';
	...
	foreach ( $results as $result ) {
		...
		if ($result->post_type == 'post') {
		    	$search_icon =	'<i class="fa fa-fw fa-' . $search_post_icon . '"></i> ';
		    	$search_post_type =	__('Post', 'pressapps' );
	    } elseif ($result->post_type == 'page') {
	    	$search_icon =	'<i class="fa fa-fw fa-' . $search_page_icon . '"></i> ';
	    	$search_post_type =	__('Page', 'pressapps' ); 
	    } elseif ($result->post_type == 'faq') {
	    	$search_icon =	'<i class="fa fa-fw fa-' . $search_faq_icon . '"></i> ';
	    	$search_post_type =	__('Faq', 'pressapps' ); 
	    } elseif ($result->post_type == 'knowledgebase') {
	    	$search_icon =	'<i class="fa fa-fw fa-' . $search_kb_icon . '"></i> ';
	    	$search_post_type =	__('KB', 'pressapps' ); 
	    } elseif ($result->post_type == 'document') {
	    	$search_icon =	'<i class="fa fa-fw fa-' . $search_document_icon . '"></i> ';
	    	$search_post_type =	__('Doc', 'pressapps' ); 
	    } elseif ($result->post_type == 'video') {
	    	$search_icon =	'<i class="fa fa-fw fa-' . $search_video_icon . '"></i> ';
	    	$search_post_type =	__('Video', 'pressapps' ); 
	    } else {
	    	$search_icon =	'<i class="fa fa-fw fa-' . $search_default_icon . '"></i> ';
	    	$search_post_type =	__('Other', 'pressapps' ); 
	    }
	    	$search_css = '';
...
function pa_meta_box_callback( $post ) {
	...
	echo '<p>';
	_e( 'Enter video embed code', 'pressapps' );
	echo '</p> ';
}
