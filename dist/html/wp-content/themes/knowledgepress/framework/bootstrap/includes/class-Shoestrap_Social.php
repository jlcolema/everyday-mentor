	...
	*/
	class Shoestrap_Social {
		...
		function get_social_links() {
			...
			$networks[] = array( 'url' => $ss_settings['bitbucket_link'],    'icon' => 'bitbucket', 'fullname' => 'Bitbucket' );
			...
			$networks[] = array( 'url' => $ss_settings['google_plus_link'],  'icon' => 'google-plus', 'fullname' => 'Google+' );
			...
			$networks[] = array( 'url' => $ss_settings['vimeo_link'],        'icon' => 'vimeo-square',      'fullname' => 'Vimeo' );
