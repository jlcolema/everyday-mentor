		...
		function css() {
			...
			$style = '.content-info {';
				...
				if ( isset( $ss_settings['layout_gutter'] ) ) {
					$style .= 'padding-top:' . $ss_settings['layout_gutter'] * 3 . 'px;';
					$style .= 'padding-bottom:' . $ss_settings['layout_gutter'] / 2 . 'px;';
				}

				$style .= ( ! empty($top_margin) ) ? 'margin-top:'. $top_margin .'px;' : '';
			$style .= '}';
			$style .= '#footer-copyright { margin-top:' . $ss_settings['layout_gutter'] * 2.5 . 'px;  }';
			$style .= '.content a:hover { color:' . $cl_brand_hover . ' }';
			$style .= '.btn:hover { background-color:' . $cl_brand_hover . '!important; border-color:' . $cl_brand_hover . '!important }';
